...
router.post('/api/user/createUser', UserController.verifyTokenAndAdminAuth, UserController.apiCreateUser)
router.put("/api/user/putUser", UserController.verifyTokenAndAdminAuth, UserController.apiPutUser);
